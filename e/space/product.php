...
$query="select id,classid,ttid,titleurl,title,titlepic,smalltext from {$dbtbpre}ecms_".$mr['tbname']." where ".$yhadd.$add;
$totalquery="select count(*) as total from {$dbtbpre}ecms_".$mr['tbname']." where ".$yhadd.$add;
...
$onmenu = 'product';
require('template/'.$spacestyle.'/product.temp.php');
db_close();
$empire=null;
